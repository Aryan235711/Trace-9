...
export function UserMenu() {
  ...
  const handleLogout = () => {
    // Best-effort server-side logout endpoint (no-op today, but keeps room for future session revocation)
  ...
  const handleLeaveReview = () => {
    ...
    if (!reviewUrl) {
      notify.info('Review link not configured', 'Set VITE_REVIEW_URL to enable reviews.');
      return;
    }
