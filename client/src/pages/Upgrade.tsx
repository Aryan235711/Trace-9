        ...
        <Card className="border-primary/40">
          ...
          <CardContent className="space-y-2 text-sm text-foreground">
            ...
            <div className="pt-4 flex gap-2 flex-col sm:flex-row">
              <Button className="w-full" onClick={activatePro} disabled={loading}>
                {loading ? 'Activating…' : 'Activate Pro now'}
              </Button>
              <Button variant="outline" className="w-full" onClick={openCheckout} disabled={loading || downgrading}>
                Pay via checkout link
              </Button>
              <Button variant="ghost" className="w-full" onClick={downgrade} disabled={downgrading}>
